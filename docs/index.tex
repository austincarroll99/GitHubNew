...
<a href="story_board.html">Story Board</a>
...
\begin{verbatim}
##  [1] "ANA" "ARI" "BOS" "BUF" "CAR" "CBJ" "CGY" "CHI" "COL" "DAL" "DET" "EDM"
## [13] "FLA" "LAK" "MIN" "MTL" "NJD" "NSH" "NYI" "NYR" "OTT" "PHI" "PIT" "SEA"
## [25] "SJS" "STL" "TBL" "TOR" "VAN" "VGK" "WPG" "WSH"
\end{verbatim}
...
\begin{verbatim}
## Warning: Removed 68 rows containing non-finite
## values (`stat_bin()`).
\end{verbatim}
...
## 23 53 76 50 27 27 20  7  2  9  2  4
\end{verbatim}
...
\begin{verbatim}
## Warning: Using the `size` aesthetic in this geom
## was deprecated in ggplot2 3.4.0.
## i Please use `linewidth` in the
##   `default_aes` field and elsewhere
##   instead.
